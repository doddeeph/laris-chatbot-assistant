package id.laris.assistant.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("id.laris.assistant.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("id.laris.assistant.security.DomainUserDetailsService", "createSpringSecurityUser");
